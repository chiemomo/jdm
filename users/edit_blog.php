...
{
	$update = mysql_query("UPDATE ".USER_BLOG." SET blog_title = '".filter($_POST['blogtitle'])."', blog_entry = '".filter($_POST['blogentry'])."', time_submitted = '".$date."' WHERE blog_id = '".($_POST['blogid'])."';") or die(mysql_error());
